...
For this project, *Amazon Reviews Dataset* is used. In the dataset, each line corresponds to a review in JSON format. The following entries are contained in each dictionary:
